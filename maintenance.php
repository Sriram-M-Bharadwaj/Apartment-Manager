<?php
   ...
   // $whomtomeet=$_POST['whomtomeet'];
    ...
    $query=mysqli_query($con,"INSERT into maintenance(apt_no, Amount, Due_date) value('$apartmentno','$amount', '$duedate')");

    if ($query){
        $msg="Maintenance details has been added";
    } else {
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Maintenance Fee issue Form
        <!-- <small>Control panel</small> -->
      </h1>
      <ol class="breadcrumb">
        <li><a href="dashboard.php"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Maintenance Entry</li>
      </ol>
    </section>
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <!-- <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="apartmentno" id="aptartmentno" required>
                  </div> -->
                  <!-- /.form-group -->
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="duedate" id="duedate" required>
                  </div>
