<?php
    ...
    $query=mysqli_query($con,"DELETE FROM apartment where apartment_number= $aptno");
      ...
      <?php if($msg){ echo "<div class='alert alert-success alert-dismissible'>
        ...
        <div class="box box-default">
          <div class="box-header with-border">
            <h3 class="box-title">Select apartment</h3>
          ...
          <!-- /.box-header -->
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="aptno" id="aptno" required>
                  </div>
                  <!-- /.form-group -->
            ...
            <button type="submit" class="btn btn-block btn-primary btn-lg" name="submit">Submit </button>
            </div>
          </div>
          </form>
